                              ...
                              <div class="float-left data1">
                                  ...
                                  <br/>
                                            <div class="wrap-input100">
                                              ...
                                              <textarea class="input101" type="text" name="isi" placeholder="Isi Content Disini" data-ready="false"></textarea>
...
<?php
 require_once("config.php");
		...
		if(isset($_POST['submit'])){
			...
			$path  = "images/".$photobaru;

			if(move_uploaded_file($tmp, $path )) {$query 	= "INSERT INTO tbl_barang VALUES ('".$id."', '".$nama."', '".$harga."', '".$qty."', '".$photobaru."')";
			}
